...
//   // if geometry was created in blender, smoothing it will create index
//   geometry = mergeVertices(geometry); // exponentially expensive operation to convert geometry into indexed geometry
// }
// geometry.computeTangents(); // create tangent attribute (needs index)
