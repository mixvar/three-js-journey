...
const injectVertexShaderFragment = (params, anchor, shader) => {
...
material.onBeforeCompile = (params, renderer) => {
  params.uniforms = {
    ...params.uniforms,
    ...customUniforms,
  };

  injectVertexShaderFragment(
    params,
    "#include <common>",
    `
    uniform float uTime;
...
// messing with depthMaterial fixes issues with drop shadow
depthMaterial.onBeforeCompile = (params) => {
  params.uniforms = {
    ...params.uniforms,
    ...customUniforms,
  };
  ...
  console.log("depthMaterial.vertexShader\n", params.vertexShader);
};
