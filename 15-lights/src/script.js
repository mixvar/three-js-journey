...
directionalLight.position.set(1, 0.26, 0);
...
// gui.add(pointLight, "intensity").min(0).max(1).step(0.1);
...
const rectAreaLight = new THREE.RectAreaLight(0x4c00ff, 1, 2, 2);
rectAreaLight.position.set(1, -1, 1);
rectAreaLight.lookAt(new THREE.Vector3(0, 0, 0));
scene.add(rectAreaLight);
scene.add(new RectAreaLightHelper(rectAreaLight));

const spotlight = new THREE.SpotLight(0x78ff00, 0.7, 10, Math.PI * 0.1, 0.4, 1);
